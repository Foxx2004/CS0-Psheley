...
def Window():
    ...
    WindowA()
    print(
"""| You walk up to the window and hear the pitter patter of rain on the glass                                     | """)
 #                                                                                      for normal text line--->|  |<-- place here for """ 
    while True:

        print(
"""-----------------------------------------------------------------------------------------------------------------""")
        ChoiceOne = input("Do you want to open the window: [Y/N]? ")
...
def WindowD():
    ...
    if key == True:
        input(
"""Taking out the brass key you stick it into the lock at the bottom of window, it slides up with a loud screech""")
        window == True
        bathroom()

    else:
        input(
"""You pull up but it wont budge, you look down to see a small brass key hole, if only you had the key.""")
        Right()
main()