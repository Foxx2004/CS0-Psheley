'''
Name: Parker Sheley - fixed
Date: 2/15/2024 - fixed
...
test = king, queen, rooks, bishops, knights, pawns = map(int, input().split())
...
#FIXME 7: make a function that prints the solution- fixed
